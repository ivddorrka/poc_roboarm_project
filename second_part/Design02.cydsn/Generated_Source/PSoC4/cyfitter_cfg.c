...
static void ClockSetup(void)
{
	...
	CY_SET_REG32((void *)(CYREG_PERI_PCLK_CTL9), 0x00000041u);
	...
	CY_SET_REG32((void *)(CYREG_PERI_PCLK_CTL7), 0x00000042u);
...
void cyfitter_cfg(void)
{
...

	{
		...
		CY_SET_REG32((void *)(CYREG_HSIOM_PORT_SEL1), 0x00333003u);
		CY_SET_REG32((void *)(CYREG_HSIOM_PORT_SEL2), 0x03000000u);
		...
		CY_SET_REG32((void *)(CYREG_UDB_PA1_CFG8), 0x5C940000u);

		/* UDB_PA_2 Starting address: CYDEV_UDB_PA2_BASE */
		CY_SET_REG32((void *)(CYDEV_UDB_PA2_BASE), 0x00990000u);
		CY_SET_REG32((void *)(CYREG_UDB_PA2_CFG8), 0x45000000u);
	...
	CY_SET_REG32((void *)(CYREG_GPIO_PRT0_PC), 0x00DB6C06u);

	/* IOPINS0_1 Starting address: CYDEV_GPIO_PRT1_BASE */
	CY_SET_REG32((void *)(CYDEV_GPIO_PRT1_BASE), 0x00000039u);
	CY_SET_REG32((void *)(CYREG_GPIO_PRT1_PC), 0x00036C06u);
