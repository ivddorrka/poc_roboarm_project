...
#define Pin_Button_0_PS		(Pin_Button__0__PS)
#define Pin_Button_0_PC		(Pin_Button__0__PC)
#define Pin_Button_0_DR		(Pin_Button__0__DR)
#define Pin_Button_0_SHIFT	(Pin_Button__0__SHIFT)
#define Pin_Button_0_INTR	((uint16)((uint16)0x0003u << (Pin_Button__0__SHIFT*2u)))
